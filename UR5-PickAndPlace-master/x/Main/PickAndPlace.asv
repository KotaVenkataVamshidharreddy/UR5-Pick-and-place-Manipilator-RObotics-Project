...
%% Utility Functions
function check_singularity(J)
    % Function to check if the robot is approaching singularity
    % Inputs:
    %   J - Jacobian matrix

    % Calculate the condition number of the Jacobian matrix
    cond_num = cond(J);
    
    % Threshold for condition number to consider as near singular
    threshold = 1e10;
