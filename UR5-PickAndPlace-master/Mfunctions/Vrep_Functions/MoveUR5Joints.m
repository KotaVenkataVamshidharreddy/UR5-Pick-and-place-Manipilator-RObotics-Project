function MoveUR5Joints(id, vrep, handles, Theta )
%% 
...
% Act
    for j = 1:6
            res =vrep.simxSetJointTargetPosition(id, handles.ur5Joints(j),...
...
%Check that action 
        ...
        % Get current joint angles for each joint
            for i = 1:6
                [res,currentTheta(i)] = vrep.simxGetJointPosition(id, handles.ur5Joints(i),...
